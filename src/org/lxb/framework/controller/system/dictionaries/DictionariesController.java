package org.lxb.framework.controller.system.dictionaries;
 ...
 * 数据字典
 * 
 * @author linxinbin 2016年6月23日 下午6:49:53
 */
@Controller
...
public class DictionariesController extends BaseController
{
	...
	private static final long serialVersionUID = -6622312645716983984L;
	...
	public ModelAndView listAllDict(Model model, String DICTIONARIES_ID) throws Exception
	{
		...
		try
		{
			// 关于产品类别的配置不要在数据字典的管理中
			List<Dictionaries> listRootDict = dictionariesService.listAllDict("0", "dictionaries/list.do");
			JSONArray arr = JSONArray.fromObject(listRootDict);
