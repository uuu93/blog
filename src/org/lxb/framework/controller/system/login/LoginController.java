package org.lxb.framework.controller.system.login;
...
public class LoginController extends BaseController
{
	...
	private static final long serialVersionUID = 8434062132281757116L;
	...
	public ModelAndView logout()
	{
		...
		try
		{
			USERNAME = Jurisdiction.getUsername(); // 当前登录的用户名
		}
		catch (Exception e)
		{
	...
	public ModelAndView updateSystem()
	{
		ModelAndView mv = this.getModelAndView();
		// 刷新首页
		mv.setViewName("redirect:/login_default");
		return mv;
	}
