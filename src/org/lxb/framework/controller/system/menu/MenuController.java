package org.lxb.framework.controller.system.menu;
...
import org.lxb.framework.util.RightsHelper;
...
public class MenuController extends BaseController
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8493339556384566195L;
	...
	public ModelAndView list() throws Exception
	{
		...
		try
		{
			String MENU_ID = (null == pd.get("MENU_ID") || "".equals(pd.get("MENU_ID").toString())) ? "0" : pd.get("MENU_ID")
					.toString();
	...
	public ModelAndView toAdd() throws Exception
	{
		...
		try
		{
			...
			pd = this.getPageData();
			String MENU_ID = (null == pd.get("MENU_ID") || "".equals(pd.get("MENU_ID").toString())) ? "0" : pd.get("MENU_ID")
					.toString();// 接收传过来的上级菜单ID,如果上级为顶级就取值“0”
