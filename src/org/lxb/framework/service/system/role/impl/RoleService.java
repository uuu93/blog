package org.lxb.framework.service.system.role.impl;
...
public class RoleService implements IRoleService{
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PageData> getRoleStatistics() {
		List<PageData> result = null;
		try {
			 result = (List<PageData>)dao.findForList("RoleMapper.statistics", null);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return result;
