...
/**
 * 说明：图片水印处理类 （报错注意：用安装版的jdk，不要用开发工具自带的jdk） 创建人：FH Q313596790 修改时间：2013年12月1日
 * 
 * @version
 */
public class Watermark
{
	...
	public static void setWatemark(String imagePath)
	{
		...
		if (null != strIWATERM && !"".equals(strIWATERM))
		{
			...
			if (strIW.length == 4)
			{
				...
				{
					pressImage(ContextUtil.getParam(ParamConst.RES_DIR).getString("VAL") + strIW[1], imagePath,
	...
	public final static void pressImage(String pressImg, String targetImg, int x, int y)
	{
		try
		{
			...
			// g.drawImage(src_biao, (wideth - wideth_biao) / 2,(height - height_biao) / 2, wideth_biao,
			// height_biao, null);
