package org.lxb.framework.util.mail;
...
public class SimpleMailSender extends BaseController
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4032163800797940356L;
	...
	public static void sendEmail(String SMTP, String PORT, String EMAIL, String PAW, String toEMAIL, String TITLE,
			String CONTENT, String TYPE, boolean ssl) throws Exception
	{
		// 这个类主要是设置邮件
		MailSenderInfo mailInfo = new MailSenderInfo();
