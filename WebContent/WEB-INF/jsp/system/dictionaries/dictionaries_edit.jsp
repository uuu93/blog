	...
	<div class="main-content">
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
					<form id="uploadform" action="common/upload/save.do" class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
						<table class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">新图标:</td>
								<td style="wdith:100px;text-align:right"><input type="file" id="FILE_SELECT" name="files" required="required" onchange="fileType(this)" /></td>
							</tr>
							<tr>
								<td class="center" colspan="10">
									<a class="btn btn-mini btn-primary" onclick="upload();">上传</a>
								</td>
							</tr>
						</table>
					</form>
					<form action="dictionaries/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" id="ICON" name="ICON" value="${pd.ICON}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td id="pd_icon">
									<c:if test="${not empty pd.ICON }">
										<img src="${res_path}${pd.ICON}" width="100">
									</c:if>
								</td>
							</tr>
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">简体:</td>
								<td><input type="text" name="NAME" id="NAME" value="${pd.NAME}" maxlength="50" placeholder="这里输入简体中文" title="简体中文" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">繁体:</td>
								<td><input type="text" name="NAME_TW" id="NAME_TW" value="${pd.NAME_TW}" maxlength="50" placeholder="这里输入繁体中文" title="繁体中文" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">日文:</td>
								<td><input type="text" name="NAME_JA" id="NAME_JA" value="${pd.NAME_JA}" maxlength="50" placeholder="这里输入日文" title="日文" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:70px;text-align: right;padding-top: 13px;">马来文:</td>
								<td><input type="text" name="NAME_MY" id="NAME_MY" value="${pd.NAME_MY}" maxlength="50" placeholder="这里输入马来文" title="马来文" style="width:98%;"/></td>
							</tr>
							<tr>
	...
	<script src="static/ace/js/ace/elements.fileinput.js"></script>
		...
		function fileType(obj){
		    ...
		    if(fileType != '.gif' && fileType != '.png' && fileType != '.jpg' && fileType != '.jpeg'){
		    	...
		    	$("#FILE_SELECT").val('');
		    	document.getElementById("FILE_SELECT").files[0] = '请选择图片';
		    }
		}
			...
			$("#uploadform").ajaxSubmit({
                ...
                success: function (data) { 
                   if(data && data.length > 0){
                	   $("#ICON").val(data[0].path);
                	   $("#pd_icon").html("<img src='${res_path}" + data[0].path+"' width='100'>");
                	   $("#FILE_SELECT").tips({
       					side:3,
       		            msg:'上传成功',
       		            bg:'#AE81FF',
