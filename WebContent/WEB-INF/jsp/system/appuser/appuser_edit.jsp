						...
						<form action="happuser/${msg }.do" name="userForm" id="userForm" method="post">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td><input type="tel" name="PHONE" id="PHONE" value="${pd.PHONE }" placeholder="这里输入手机号" title="手机号" onblur="hasP('${pd.USERNAME }')" style="width:98%;" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="YEARS" id="YEARS" class="input_txt" value="${pd.YEARS }" placeholder="开通年限(请输入数字)" title="开通年限" style="width:98%;" /></td>
								</tr>
								<tr>
